...
const LandingPage = () => {
  ...
  return (
    <div className={`h-[100vh] flex items-center justify-center p-4 ${gradientBg} overflow-x-hidden`}>
      <div className="container mx-auto max-w-7xl">
        {/* Header */}
        <header className="flex justify-between items-center mb-[100px] py-0 px-6 md:px-6 lg:px-8">
        ...
        {/* Main Section */}
        <main className="flex flex-col md:flex-row items-center justify-between mt-10 md:mt-16 gap-8 md:gap-12 lg:gap-14">
          {/* Left Content */}
          <div className="md:w-1/2 text-center md:text-left px-4 sm:px-6 md:pl-12">
